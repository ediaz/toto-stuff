/* 2D Helmholtz solver by LU factorization: solves for the Greens function and its derivative . */
/*
Copyright (C) 2012 University of Texas at Austin
Modified by:  Ramzi Djebbi (2013 KAUST)
...
{
    bool verb;
    int n1, n2, npw, npml, pad1, pad2, is, ns, ix, iz;
    ...
    sf_init(argc,argv);
    in  = sf_input("in"); /* Velocity file */
    out = sf_output("out"); /* Green's function solution */
    ...
    if (verb) sf_warning("Solving for the Green's function...");
