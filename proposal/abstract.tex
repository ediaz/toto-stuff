\begin{abstract}
Wavefield-based imaging and tomography have proven to be a robust technology
...
is beneficial for updating the desired components of the background velocity
model. Aside from the data itself, the velocity model is the most important
...
to increase such consistency. In general, I see two main families of methods: image-domain
