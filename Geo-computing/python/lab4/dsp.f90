...
interface dsp_smooth1
  module procedure dsp_smooth1_1d, dsp_smooth1_2d
end interface


interface dsp_smooth
  module procedure dsp_smooth1d, dsp_smooth2d    
end interface
...
y=0.0
!$omp parallel do private(i) shared(a,x,y,n1)
do i=1,n2
  call dsp_smooth1_1d(a,x(:,i),y(:,i),n1)
enddo
