...
For readability, I split the code in three modules, and a main script:
...
========================================================================
The report report_Esteban_Diaz.pdf 
is in the folder report.
 I included the .tex files so the report can be reproduced.
